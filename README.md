...
This can be used for a variety of purposes (best route between cities,routes etc.). In our project we will try to simulate it as closely as can be to a small area as we said before.
