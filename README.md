...
6. Implement a GUI (graphics) that will show the Graph:
   ...
   [^4.3]: <a href="https://github.com/netanellevine/Weighted_Graph_Algorithms/blob/main/src/main/java/api/MyPanel.java">MyPanel Class</a>
   [^5.4]: <a href="https://github.com/netanellevine/Weighted_Graph_Algorithms/blob/main/src/main/java/api/Help.java">Help Class</a>
